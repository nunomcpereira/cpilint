...
public final class XpathRulesUtil {
	
	private XpathRulesUtil() {
		throw new AssertionError("Never supposed to be instantiated");
	}
	
	public static void iterateSingleXpathAndConsumeIssues(IflowXml iflowXml, String xpath, Function<XdmNode, Issue> issueFunction, Consumer<Issue> issueConsumer) {
	...
	public static <T> void iterateMultipleXpathsAndConsumeIssues(IflowXml iflowXml, Set<T> tSet, Function<T, String> xpathFunction, Function<T, Function<XdmNode, Issue>> issueFunctionFunction, Consumer<Issue> issueConsumer) {
		for (T t : tSet) {
	...
	public static String negateXpathPredicate(String predicate) {
		/*
